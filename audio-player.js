...
(() => {
  ...
  async function playNarration(button) {
    ...
    if (recording?.url) {
      ...
      media.onwaiting = () =>
        currentMedia === media && setPlayerState("loading");
